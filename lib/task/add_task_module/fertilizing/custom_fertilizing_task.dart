...
//       home: CustomfertilizingSchedulePage(),
//     );
//   }
// }

class CustomfertilizingSchedulePage extends StatefulWidget {
  final String plantID;
  const CustomfertilizingSchedulePage({super.key, required this.plantID});
  @override
  _CustomSchedulePageState createState() => _CustomSchedulePageState();
}

class _CustomSchedulePageState extends State<CustomfertilizingSchedulePage> {
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Spacer(),
          Text('Fertilizing', style: TextStyle(fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
  ...
  Widget _buildHelpRow() {
    return Center(
      child: TextButton.icon(
        ...
        label: const Text('Learn how to and when to Fertilize your plant?',
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Set the number of days you want to repeat for Fertilizing',
              ...
              const SizedBox(height: 16),
              Text(
                'Fertilize after every $repeatEveryDays days',
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                selectedTime != null
                    ? 'Remind to Fertilize at ${selectedTime!.format(context)}'
                    : 'Set reminder time',
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'Custom Fertilizing activity scheduled successfully',
