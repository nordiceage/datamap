...
class CustomProgressSchedulePage extends StatefulWidget {
  final String plantID;

  const CustomProgressSchedulePage({super.key, required this.plantID});

  @override
  _CustomProgressSchedulePage createState() => _CustomProgressSchedulePage();
}

class _CustomProgressSchedulePage extends State<CustomProgressSchedulePage> {
  ...
  Widget _buildHelpRow() {
    return Center(
      child: TextButton.icon(
        ...
        label: const Text('Learn how to make effective progress updates?',
  ...
  Widget _buildSaveButton() {
    return Center(
      child: ElevatedButton(
        onPressed: isSaveEnabled ? () => _showSuccessPopup(context) : null,
        style: ButtonStyle(
          minimumSize:
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Set the number of days you want to repeat progress updates',
              ...
              const SizedBox(height: 16),
              Text(
                'Update progress after every $repeatEveryDays days',
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                selectedTime != null
                    ? 'Remind to update progress at ${selectedTime!.format(context)}'
                    : 'Set reminder time',
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'Custom Progress Update activity scheduled successfully',
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.update, color: Colors.blue, size: 40),
                      const SizedBox(width: 16),
                      const Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
