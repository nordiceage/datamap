...
class CustomMistingSchedulePage extends StatefulWidget {
  final String plantID;

  const CustomMistingSchedulePage({super.key, required this.plantID});
  @override
  _CustomSchedulePageState createState() => _CustomSchedulePageState();
}

class _CustomSchedulePageState extends State<CustomMistingSchedulePage> {
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Spacer(),
          Text('Mist', style: TextStyle(fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
  ...
  Widget _buildHelpRow() {
    return Center(
      child: TextButton.icon(
        ...
        label: const Text('Learn how to and when to mist your plant?',
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Set the number of days you want to repeat for misting',
              ...
              const SizedBox(height: 16),
              Text(
                'Mist after every $repeatEveryDays days',
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                selectedTime != null
                    ? 'Remind to mist at ${selectedTime!.format(context)}'
                    : 'Set reminder time',
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'Custom misting activity scheduled successfully',
